...
<div class="catalogo" id="product-list">
  ...
  <div class="ropa">
    ...
    <a href="" class="conttxt">
      <h3 class="nombre">
        Adidas - Zapatillas Runing Training Blancas-Mujer
      </h3>
      <div class="precio">
        <h4>S/. 141.00 PEN</h4>
      </div>
  ...
  <div class="ropa">
    ...
    <a href="" class="conttxt">
      <h3 class="nombre">
        Adidas - Zapatillas Runing Training Negro-Hombre
      </h3>
      <div class="precio">
        <h4>S/. 159.00 PEN</h4>
      </div>
  ...
  <div class="ropa">
    ...
    <a href="" class="conttxt">
      <h3 class="nombre">Adidas - Zapatillas Deportiva Runing Negra</h3>
      <div class="precio">
        <h4>S/. 159.00 PEN</h4>
      </div>
    </a>
  ...
  <div class="ropa">
    ...
    <a href="" class="conttxt">
      <h3 class="nombre">Adidas - Zapatillas Chimpunes para Hombre</h3>
      <div class="precio">
        <h4>S/. 399.00 PEN</h4>
      </div>
    </a>
  ...
  <div class="ropa">
    ...
    <a href="" class="conttxt">
      <h3 class="nombre">Adidas - Zapatillas Deportivas Chimpunes</h3>
      <div class="precio">
        <h4>S/. 299.00 PEN</h4>
      </div>
    </a>
  ...
  <div class="ropa">
    ...
    <a href="" class="conttxt">
      <h3 class="nombre">
        Adidas - Zapatillas Deportivas Chimpunes Negra-Hombre
      </h3>
      <div class="precio">
        <h4>S/. 499.00 PEN</h4>
      </div>
