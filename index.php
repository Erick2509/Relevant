...
<div class="banner2" id="banner2">
  <img src="imagenes/img_inicio/responsive/banner0.jpg" alt="" class="activo" />
...
<div class="contenedor">
  <div class="contenido">
    <div class="cont">
      <div class="obj">
        <a href=""><img class="img1" src="imagenes/img_inicio/ad1.1.webp" alt="" /></a>
        <a href="catalogo.php"><img class="top" src="imagenes/img_inicio/adi1.png" alt="" /></a>
      </div>
    </div>
    <div class="cont">
      <div class="obj">
        <a href=""><img class="img1" src="imagenes/img_inicio/puma1.1.jpg" alt="" /></a>
        <a href="catalogo.php"><img class="top" src="imagenes/img_inicio/puma1.jpg" alt="" /></a>
      </div>
    </div>
    <div class="cont">
      <div class="obj">
        <a href=""><img class="img1" src="imagenes/img_inicio/adi2.1.webp" alt="" /></a>
        <a href="catalogo.php"><img class="top" src="imagenes/img_inicio/adi2.png" alt="" /></a>
      </div>
    </div>
  </div>
</div>
